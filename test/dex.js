...
contract("Dex", (accounts) => {
    ...
    it("should NOT deposit token if token does not exist", async() => {
        await expectRevert(
            dex.deposit(
                ...
                web3.utils.fromAscii("TOKEN-DOES-NOT-EXIST"), { from: trader1 }
            ),
    ...
    it("should create market order and match against existing limit orders", async() => {
        await dex.deposit(
            web3.utils.toWei("100"),
            DAI, { from: trader1 }
        );
